...
from src.requests.snippet_list import SnippetListInvalidRequest
...
def test_reponse_failure_has_type_and_message():
    response = ResponseFailure(
        GENERIC_RESPONSE_TYPE, GENERIC_RESPONSE_MESSAGE
    )
...
def test_response_failure_from_invalid_request_with_errors():
    request = SnippetListInvalidRequest()
